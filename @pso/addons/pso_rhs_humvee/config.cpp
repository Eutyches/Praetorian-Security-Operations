...
Retextures by Corey of Praetorian Security Operations.
*/
...
class CfgVehicles
{
	...
	class rhsusf_m998_pso_black: rhsusf_m998_d_2dr;
	{
		...
		DLC = "";
		hiddenSelections[] = {"exterior","interior","A2","wheels","mainbody","hood gratting","camo1","camo2","unitdecals_1","unitdecals_2","ind_wait","ind_brake","ind_highbeam"};
		hiddenSelectionsTextures[] = {"pso_rhs_humvee\paa\m998_exterior_d_co.paa","pso_rhs_humvee\paa\m998_interior_d_co.paa","pso_rhs_humvee\paa\A2_parts_D_co.paa","pso_rhs_humvee\paa\wheel_wranglermt_d_co.paa","pso_rhs_humvee\paa\m998_mainbody_d_co.paa","pso_rhs_humvee\paa\gratting_d_co.paa","pso_rhs_humvee\paa\tile_exmetal_d_co.paa","pso_rhs_humvee\paa\m1025_d_co.paa","pso_rhs_humvee\paa\101stab_502reg_2ndbn_a12_d_co.paa","pso_rhs_humvee\paa\a12^_co.paa"};
	};
